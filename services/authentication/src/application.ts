...
import {AuthenticationServiceComponent, OtpMethodType, SignUpBindings} from '@sourceloop/authentication-service';
...
import { GoogleOauth2SignupProvider } from './provider';
